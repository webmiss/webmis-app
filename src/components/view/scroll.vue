<template>
  <div class="wm-scroll_body" :style="{backgroundColor: bgColor, color: color}">
    <div class="wm-scroll_ct" ref="freshContainer" @touchstart="TouchStart" @touchmove="TouchMove" @touchend="TouchEnd" @scroll="Scroll">
      <!-- 下拉刷新 -->
...
.wm-scroll_ct{position: relative; overflow-y: auto; touch-action: pan-y; width: 100%; height: 100%;}
.wm-scroll_refresh{position: absolute; left: 0; top: 0; width: 100%; text-align: center; transition: transform 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94); transform: translateZ(0);}
.wm-scroll_load{position: fixed; z-index: 9; bottom: 0; width: 100%; text-align: center;}
</style>
