<template>
  <div v-if="isShow" class="app_start_body" :style="{background: bgColor, opacity: opacity}">
    <div class="app_start">
      ...
      <h1 class="app_start_title">{{ Env.title+' '+Env.version }}</h1>
    </div>
...
.app_start{margin-top: -64px;}
.app_start_logo{width: 160px; height: 160px; background: url('../../assets/logo.svg') no-repeat center; background-size: 70%;}
.app_start_title{font-size: 21px; text-align: center;}
